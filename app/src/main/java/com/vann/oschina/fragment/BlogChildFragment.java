 ...
 */
public class BlogChildFragment extends Fragment {
    ...
    public static BlogChildFragment newInstance(String title){
        Bundle bd = new Bundle();
        bd.putString(CommonConstant.TABPAGE_TEXT, title);
        BlogChildFragment fragment = new BlogChildFragment();
